...
export const EVENTS: Event[] = [
  ...
  { id: 6, title: 'Chumarezhuth', description: 'Conduct wall writing activities, with at least one per campus unit, making it grand and attractive.', submissionType: ['Quantitative Input','Image Upload','Text Submission'], gradingType: 'Manual', maxPoints: 25, deadline: '2025-08-30' },
  ...
  { id: 12, title: 'Inter campus visit', description: 'Visit nearby campuses to promote prof summit and register students, with extra points for non-unit campuses.', submissionType: ['Quantitative Input','Image Upload','Text Submission'], gradingType: 'Manual', maxPoints: 50, deadline: '2025-09-15' },
  ...
  { id: 16, title: 'Weekly E-Posters', description: 'Release weekly e-posters on career trends and summit highlights, on social media.', submissionType: ['Image Upload','Text Submission'], gradingType: 'Manual', maxPoints: 20, deadline: '2025-09-30' },
  ...
  { id: 33, title: 'Independent Events', description: 'Organize independent events apart from the above events to promote profsummit.', submissionType: ['Text Submission','Image Upload','Media Upload'], gradingType: 'Manual', maxPoints: 5, deadline: '2025-10-31' },
];
